...
export default function Demo({ demos }: Props) {
    ...
    <div className="min-h-screen bg-[#0a1929]">
      ...
      <section className="py-20 bg-linear-to-b from-black to-[#0c1a2b]">
        <div className="max-w-225 mx-auto px-6">
          ...
          <audio
            ref={audioRef}
            src={demos[currentTrack]?.audioUrl}
            preload="metadata"
          />
          <motion.div
          ...
          >
            ...
            <div className="mb-8 text-center">
              ...
              <h2
                ...
                style={{ fontFamily: "var(--font-heading)" }}
              >
                {demos[currentTrack]?.title}
              </h2>
              <div className="text-accent">{demos[currentTrack]?.genre}</div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex justify-between mt-2 text-sm text-muted-foreground">
                <span>1:24</span>
                <span>{demos[currentTrack]?.duration}</span>
              </div>
            </div>
